"""
Django settings for ravindertest_2 project.
...
ROOT_URLCONF = 'ravindertest_2.urls'
...
WSGI_APPLICATION = 'ravindertest_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ravindertest_2 API",
    "DESCRIPTION": "API documentation for ravindertest_2 App",
    "VERSION": "v1",
}
